...
class LinkerHandAdvancedO6:
    def __init__(self,hand_type="right", hand_joint="O6", is_touch="true", can="can0", moudbus="None"):
...
if __name__ == '__main__':
    ...
    /cb_{self.hand_type}_hand_state 话题类型为 sensor_msgs/msg/JointState 60Hz
    ...
    linker_hand = LinkerHandAdvancedO6(hand_type=args.hand_type, is_touch=args.is_touch, can=args.can)
